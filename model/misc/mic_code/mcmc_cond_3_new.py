...
def mcmc_sampler(productions,
    ...
    for i in range(iter):
        ...
        # doing this for all 16 data points together
            ...
            ground_truth_trials_rev = ground_truth_labels
...
def mcmc_sampler_map(productions,
    ...
    df_rules = pd.DataFrame({"rulestring": [None] * thin_length})   # data frame for storing rules and other relevant properties
                             # "productions": [None] * thin_length,
                             # "prod_l": [None] * thin_length,
                             # "prod_d": [None] * thin_length,
                             # "li": [None] * thin_length,
...
def mcmc_sampler_map_surgery(productions,
    ...
    for i in range(iter):
        ...
        # print(t_prime_info)
        t_prime = Z.generate_res(productions, start=t_prime_info['t_prime_rule'], bound_vars=t_prime_info['t_prime_bv'])
        # print('proposal')
        # print(t_prime)
        t_prime['prec'] = rr.get_prec_recursively(rr.string_to_list(t_prime['rule']))
