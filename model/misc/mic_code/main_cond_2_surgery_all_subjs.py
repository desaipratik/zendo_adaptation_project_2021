...
#           # print(BICs_baseline_all_subjects_prior)
          ...
          with open('model_results/norm_2/rules_prior_205.txt', 'w') as filehandle:
              filehandle.writelines("%s\n" % place for place in rules_prior)
          # with open('model_results/norm_2/rules_prior_label.txt', 'w') as filehandle:
          #     filehandle.writelines("%s\n" % place for place in rules_prior_label)
          # with open('model_results/norm_2/rules_post_map.txt', 'w') as filehandle:
          #     filehandle.writelines("%s\n" % place for place in rules_post_map)
          with open('model_results/norm_2/rules_post_all_205.txt', 'w') as filehandle:
              filehandle.writelines("%s\n" % place for place in rules_post_all)
          # with open('model_results/norm_2/rules_post_all_seed.txt', 'w') as filehandle:
          #     filehandle.writelines("%s\n" % place for place in rules_post_all_seed)




          main_data_formatted.to_csv('model_results/normative_res_two_' + str(rep) + '_10k_205.csv')   # writing main data to new csv file including all relevant data for analysis
