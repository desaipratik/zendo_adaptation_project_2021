...
####################### Custom imports ########################################
from mcmc_cond_1_new_test_change_seq_ib_poiss_6 import mcmc_sampler, mcmc_sampler_map_surgery, mcmc_sampler_map
...
# #           # print(BICs_baseline_all_subjects_prior)
          ...
          with open('tr_counts'+str(rep)+'_poiss_7.txt', 'w') as f_tr:
              for item_tr in n_iter_tr:
                  f_tr.write("%s\n" % item_tr)

          with open('ts_counts'+str(rep)+'_poiss_7.txt', 'w') as f_ts:
