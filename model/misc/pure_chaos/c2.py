...
main_data_formatted = pd.read_csv('main_data_formatted_cond_two_surgery.csv')  # getting the preprocessed data file
...
#                # print(df_post_all)
               ...
               for sample in range(n_1):
                    df_post_all_seed = df_post_all_seed.append(mcmc_sampler_map(productions,
                                                                         replacements,full_training_dat_post_all,
                                                                            start=subj_rule,
                                                                            bv=bv_prior,
                                                                            ground_truth_labels=prior_response,
...
#           # print(BICs_baseline_all_subjects_prior)
          ...
          main_data_formatted.to_csv('model_results/normative_res_two_' + str(rep) + '_testingstuffs.csv')   # writing main data to new csv file including all relevant data for analysis
