...
####################### Custom imports ########################################
from mcmc_cond_1_new_test_change_seq_ib_single_edit import mcmc_sampler, mcmc_sampler_map_surgery, mcmc_sampler_map
...
main_data_formatted = pd.read_csv('main_data_formatted_cond_one_second_rule.csv')  # getting the preprocessed data file
...
#                # print(df_prior['rulestring'])
    ...
    #                     # print('dropped abvoe ')
                   ...
                   df_post_map = pd.DataFrame({'rulestring': [subj_rule] * 1})
...
#                # print(df_post_all)
               ...
               if (1 - wsls_check) > rand_n_check:
                   ...
                   df_post_all_seed = pd.DataFrame({'rulestring': [subj_rule] * 1})
...
#           # print(BICs_baseline_all_subjects_prior)
          ...
          with open('model_results/test4/rules_post_map_chain_clean_qual_l2_best_no.txt', 'w') as filehandle:
          ...
          with open('model_results/test4/rules_post_all_seed_chain_clean_qual_l2_best_no.txt', 'w') as filehandle:
              filehandle.writelines("%s\n" % place for place in rules_post_all_seed)



          main_data_formatted.to_csv('model_results/normative_res_one_' + str(rep) + '_process_models_qual_fit_poiss_l2_best.csv')   # writing main data to new csv file including all relevant data for analysis
