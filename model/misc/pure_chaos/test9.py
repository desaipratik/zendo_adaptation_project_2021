...
def predicted_selections(main_data_formatted, rules_dict,  replacements, trial_counts, n_rep = 1, n_1=1, n_2=5):  # computes the ll for getting participants responses to initial generalizations (n_1 * n_2 determines number of MCMC iterations)
     ...
     for repeat in np.arange(n_rep):     # for each repeat, an independent outuput file will be created
          ...
          for data in main_data_formatted['data'][:n_rows]:
               ...
               correct_rule_perc_prior_labels.append(prior_rule_strings_label.count(subj_rule_post))
...
#                # print(df_post_map['rulestring'])
               ...
               correct_rule_perc_post_map.append(post_map_rule_strings.count(subj_rule_post))
...
#                # print(df_post_all)
               ...
               correct_rule_perc_post_all.append(post_all_rule_strings.count(subj_rule_post))
...
#                # print(df_post_all)
               ...
               correct_rule_perc_post_all_seed.append(post_all_rule_strings_seed.count(subj_rule_post))
...
#           # print(BICs_baseline_all_subjects_prior)
          ...
          main_data_formatted.to_csv('model_results/normative_res_cond_three_' + str(rep) + 'process_models_sec_rule.csv')   # writing main data to new csv file including all relevant data for analysis
