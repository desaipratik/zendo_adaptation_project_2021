"""
Created on Sun Mar 15 15:01:21 100100
...
for trial_run in range(0,100):
    ...
    for wsls_rule_list_2,init_resp in zip(wsls_rules[:248],main_data_formatted['prior_resp'][:248]):

      wsls_rule_list = []
      for abc in eval(wsls_rule_list_2):
        if abc not in wsls_rule_list:
          wsls_rule_list.append(abc)
      ...
      for wsls_rule in wsls_rule_list:
        # print('hi')
...
rule_comps = pd.DataFrame({'q_i_s': q_i_specific, 'b_i_s': b_i_specific, 'e_i_s': e_i_specific, 'f_i_s': f_i_specific, 'r_i_s': r_i_specific,'init_prob': init_probs,
                           ...
                           'q_tr_shared': comp_mean(q_shared_all_tr,100), 'q_tr_difference': comp_mean(q_difference_all_tr,100), 'q_tr_added': comp_mean(q_added_all_tr,100), 'q_tr_removed': comp_mean(q_removed_all_tr,100),
                           'e_tr_shared': comp_mean(e_shared_all_tr,100), 'e_tr_difference': comp_mean(e_difference_all_tr,100), 'e_tr_added': comp_mean(e_added_all_tr,100), 'e_tr_removed': comp_mean(e_removed_all_tr,100),
                           'f_tr_shared': comp_mean(f_shared_all_tr,100), 'f_tr_difference': comp_mean(f_difference_all_tr,100), 'f_tr_added': comp_mean(f_added_all_tr,100), 'f_tr_removed': comp_mean(f_removed_all_tr,100),
                           'r_tr_shared': comp_mean(r_shared_all_tr,100), 'r_tr_difference': comp_mean(r_difference_all_tr,100), 'r_tr_added': comp_mean(r_added_all_tr,100), 'r_tr_removed': comp_mean(r_removed_all_tr,100),
                           'b_tr_shared': comp_mean(b_shared_all_tr,100), 'b_tr_difference': comp_mean(b_difference_all_tr,100), 'b_tr_added': comp_mean(b_added_all_tr,100), 'b_tr_removed': comp_mean(b_removed_all_tr,100),'rev_probs_tr': comp_mean(rev_probs_tr_all,100),

                           'q_ts_shared': comp_mean(q_shared_all_ts,100), 'q_ts_difference': comp_mean(q_difference_all_ts,100), 'q_ts_added': comp_mean(q_added_all_ts,100), 'q_ts_removed': comp_mean(q_removed_all_ts,100),
                           'e_ts_shared': comp_mean(e_shared_all_ts,100), 'e_ts_difference': comp_mean(e_difference_all_ts,100), 'e_ts_added': comp_mean(e_added_all_ts,100), 'e_ts_removed': comp_mean(e_removed_all_ts,100),
                           'f_ts_shared': comp_mean(f_shared_all_ts,100), 'f_ts_difference': comp_mean(f_difference_all_ts,100), 'f_ts_added': comp_mean(f_added_all_ts,100), 'f_ts_removed': comp_mean(f_removed_all_ts,100),
                           'r_ts_shared': comp_mean(r_shared_all_ts,100), 'r_ts_difference': comp_mean(r_difference_all_ts,100), 'r_ts_added': comp_mean(r_added_all_ts,100), 'r_ts_removed': comp_mean(r_removed_all_ts,100),
                           'b_ts_shared': comp_mean(b_shared_all_ts,100), 'b_ts_difference': comp_mean(b_difference_all_ts,100), 'b_ts_added': comp_mean(b_added_all_ts,100), 'b_ts_removed': comp_mean(b_removed_all_ts,100),'rev_probs_ts': comp_mean(rev_probs_tr_all,100),
