...
main_data_formatted = pd.read_csv('model_results/normative_res_one_0_process_models_change_best.csv')  # getting the preprocessed data file
...
init_probs = []
rev_probs = []
for rrrs in main_data_formatted['post_resp'][:129]:
...
for rrr in main_data_formatted['prior_resp'][:129]:
...
with open('model_results/test4_split/rules_post_all_change_best.txt', 'r') as filehandle:
...
for wsls_rule_list,init_resp in zip(wsls_rules[:129],main_data_formatted['prior_resp'][:129]):
  rev_probs_wsls_all = []
...
with open('model_results/test4_split/rules_post_all_seed_chain_ideas.txt', 'r') as filehandle:
    filecontents = filehandle.readlines()
    for line in filecontents:
        # remove linebreak which is the last character of the string
        current_place = line[:-1]
...
with open('model_results/test4_split/rules_post_map_chain_ideas', 'r') as filehandle:
    filecontents = filehandle.readlines()
    for line in filecontents:
        # remove linebreak which is the last character of the string
        current_place = line[:-1]
...
with open('model_results/norm_1_split/rules_post_all_change.txt', 'r') as filehandle:
    filecontents = filehandle.readlines()
    for line in filecontents:
        # remove linebreak which is the last character of the string
        current_place = line[:-1]
...
with open('model_results/norm_1_split/rules_prior_change.txt', 'r') as filehandle:
    filecontents = filehandle.readlines()
    for line in filecontents:
        # remove linebreak which is the last character of the string
        current_place = line[:-1]
...
for wsls_rule_list,rev_resp in zip(wsls_rules[:129],wsls_rules_post[:129]):
  rev_probs_wsls_all = []
  q_r_specific_wsls_all = []
  b_r_specific_wsls_all = []
  e_r_specific_wsls_all = []
...
print('hiheloos')
rule_comps.to_csv('model_results/rule_comp_cond_1_change_best_1_best.csv')
