...
####################### Custom imports ########################################
from mcmc_cond_1_new import mcmc_sampler, mcmc_sampler_map#, mcmc_sampler_map
...
####################### Sampling Algorithm #########################################
def predicted_selections(main_data_formatted, rules_dict,  replacements, trial_counts, n_rep = 1, n_1=1, n_2=1000):  # computes the ll for getting participants responses to initial generalizations (n_1 * n_2 determines number of MCMC iterations)
     ...
     for repeat in np.arange(n_rep):     # for each repeat, an independent outuput file will be created
          ...
          for data in main_data_formatted['data_prior'][:n_rows]:
               ...
               for sample in range(100):
                    ...
                    # print(df_post_map)
                    # print('dropped abvoe ')
                    df_post_map = df_post_map.append(mcmc_sampler_map(productions,replacements,
                                                             ...
                                                             iter = 5,
                                                             # type='posterior_map',
                                                                      bv = df_prior_labels['bv'][map_index_label],
