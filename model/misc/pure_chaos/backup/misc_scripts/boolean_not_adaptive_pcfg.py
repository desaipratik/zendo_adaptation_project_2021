...
from transform_functions import compute_orientation, check_structure, check_feat_change_both_directions
...
# default production probabilities precluding non-booleans
...
####################### Sampling Algorithm #########################################
def predicted_selections(main_data_formatted, rules_dict, n_1=1, n_2=100):  # computes the ll for getting participants responses to initial generalizations (n_1 * n_2 determines number of iterations)
     rep = 0
     ...
     for repeat in np.arange(10):
          ...
          for data in main_data_formatted['data']:
               ...
               print(correct_rule)
               full_training_dat = trials + training_data
               print(len(full_training_dat))
               ...
               #
               #
               # feat_scores = [check_feat_change_both_directions(colours,follow)['sum_values'],
               #               check_feat_change_both_directions(sizes,follow)['sum_values'],
               #               check_feat_change_both_directions(orientations,follow)['sum_values'],
               #               check_feat_change_both_directions(grounded,follow)['sum_values']]
               #
               # val_scores = [check_feat_change_both_directions(colours,follow)['val_change'],
               #               check_feat_change_both_directions(sizes,follow)['val_change'],
               #               check_feat_change_both_directions(orientations,follow)['val_change'],
               #               check_feat_change_both_directions(grounded,follow)['val_change']]
               #
               #
               ...
               df_prior = mh_mcmc_sampler_res(productions, full_training_dat,Dwin=Dwin,ground_truth=False, iter = 0)[0] # creating empty data for first initial rules
               prior_details = [] # details for prior rules are needed to run the map mcmc chain which starts with the map rule of the prior

               # post map chain
               df_post_map = mh_mcmc_sampler_res(productions, trials,Dwin=Dwin ,ground_truth=False, iter = 0)[0] # creating empty data for revised rules

               # post all chain
               df_post_all = mh_mcmc_sampler_res(productions, trials, Dwin=Dwin ,iter = 0)[0] # creating empty data for all rules
               ...
               if len(fitted_taus_prior) % 5 == 0:
                    ...
                    if len(fitted_taus_prior) % 200 == 0:
                         ...
                         BICs_model_all_subjects_prior.append(-2 * fitted_results_all_subjects_prior[1] + 1 * np.log(40 * len(fitted_taus_prior)))
                         ...
                         BICs_model_all_subjects_post_map.append(-2 * fitted_results_all_subjects_post_map[1] + 1 * np.log(40 * len(fitted_taus_prior)))
                         ...
                         BICs_model_all_subjects_post_all.append(-2 * fitted_results_all_subjects_post_all[1] + 1 * np.log(40 * len(fitted_taus_prior)))


                         # baseline


                         baseline_probs_all_subjects = [.5] * 40 * 200
                         ...
                         # overall accuracy
                         gt_all_subjects = gt * 5 * len(fitted_taus_prior) # ground truth
          ...
          main_data_formatted['fitted_taus_all_subjects_prior'] = fitted_taus_all_subjects_prior * 200
          main_data_formatted['select_probs_all_subjects_prior'] = select_probs_all_subjects_prior * 200
          main_data_formatted['ll_model_all_subjects_prior'] = ll_model_all_subjects_prior * 200
          main_data_formatted['BICs_model_all_subjects_prior'] = BICs_model_all_subjects_prior * 200
          main_data_formatted['ll_baseline_all_subjects_prior'] = ll_baseline_all_subjects_prior * 200
          main_data_formatted['BICs_baseline_all_subjects_prior'] = BICs_baseline_all_subjects_prior * 200
          ...
          main_data_formatted['fitted_taus_all_subjects_post_map'] = fitted_taus_all_subjects_post_map * 200
          main_data_formatted['select_probs_all_subjects_post_map'] = select_probs_all_subjects_post_map * 200
          main_data_formatted['ll_model_all_subjects_post_map'] = ll_model_all_subjects_post_map * 200
          main_data_formatted['BICs_model_all_subjects_post_map'] = BICs_model_all_subjects_post_map * 200
          main_data_formatted['ll_baseline_all_subjects_post_map'] = ll_baseline_all_subjects_prior * 200
          main_data_formatted['BICs_baseline_all_subjects_post_map'] = BICs_baseline_all_subjects_prior * 200
          ...
          main_data_formatted['fitted_taus_all_subjects_post_all'] = fitted_taus_all_subjects_post_all * 200
          main_data_formatted['select_probs_all_subjects_post_all'] = select_probs_all_subjects_post_all * 200
          main_data_formatted['ll_model_all_subjects_post_all'] = ll_model_all_subjects_post_all * 200
          main_data_formatted['BICs_model_all_subjects_post_all'] = BICs_model_all_subjects_post_all * 200
          main_data_formatted['ll_baseline_all_subjects_post_all'] = ll_baseline_all_subjects_prior * 200
          main_data_formatted['BICs_baseline_all_subjects_post_all'] = BICs_baseline_all_subjects_prior * 200
          ...
          main_data_formatted.to_csv('summary_no_adaptive_pruned_grammar_10_remain_val_probs' + str(rep) + '.csv')   # writing main data to new csv file including all relevant data for analysis

          rep+=1

predicted_selections(main_data_formatted, rules_dict)
