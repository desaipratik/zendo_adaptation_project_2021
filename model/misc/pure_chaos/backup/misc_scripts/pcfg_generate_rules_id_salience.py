...
def mh_mcmc_sampler(productions, data, ground_truth = None, start="S",
    ...
    for i in range(iter):
        ...
        for i_2 in range(0, len(data)):   # first looping over all 8 scenese
            ...
            res_c_r.append(eval("ob.exists(lambda x: ob.equal(x,  'red', 'colour'), X)"))
        ...
        z_t_c_r = [a and b for a, b in zip(ground_truth, res_c_r)]
        print(z_t_c_r)
