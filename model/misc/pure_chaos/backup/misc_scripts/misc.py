...
def predicted_selections(main_data_formatted, n_1=1, n_2=100):  # computes the ll for getting participants responses to initial generalizations (n_1 * n_2 determines number of iterations)
     ...
     for data in main_data_formatted['data'][:100]:
          ...
          print(s)
          print(k)
          k = [float(norm)/sum(k) for norm in k]
          print(k)
          ...
          # prior chain
          df_prior = mh_mcmc_sampler_res(productions, trials, Dwin=k, ground_truth=False, iter = 0)[0] # creating empty data for first initial rules
     ...
     main_data_formatted.to_csv('summary_catdog_.csv')   # writing main data to new csv file including all relevant data for analysis
