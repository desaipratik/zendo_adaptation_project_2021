...
####################### Sampling Algorithm #########################################
def predicted_selections(main_data_formatted,n_rep=1, n_1=1, n_2=100):  # computes the ll for getting participants responses to initial generalizations (n_1 * n_2 determines number of iterations)
     ...
     ################ APPENDING ALL DATA TO MAIN DATA FRAME ########################
          ...
          main_data_formatted.to_csv('full_comparison_10_survive/8_training_data/full_comparison_5_penalisation' + str(rep) + '.csv')   # writing main data to new csv file including all relevant data for analysis
