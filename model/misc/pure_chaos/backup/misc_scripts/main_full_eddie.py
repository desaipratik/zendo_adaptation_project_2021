...
####################### Custom imports ########################################
from st_change_formula import mh_mcmc_sampler
...
####################### Sampling Algorithm #########################################
def predicted_selections(main_data_formatted, n_1=1, n_2=1000):  # computes the ll for getting participants responses to initial generalizations (n_1 * n_2 determines number of iterations)
     ...
     for data in main_data_formatted['data'][:10]:
     ...
     main_data_formatted = main_data_formatted[:10]
     ...
     main_data_formatted.to_csv('summary_flip_denominator.csv')   # writing main data to new csv file including all relevant data for analysis
