...
main_data_formatted = pd.read_csv('c_2_change.csv')  # getting the preprocessed data file
...
#           # print(BICs_baseline_all_subjects_prior)
          ...
          with open('model_results/norm_2_split/rules_prior_change.txt', 'w') as filehandle:
              filehandle.writelines("%s\n" % place for place in rules_prior)
          with open('model_results/norm_2_split/rules_prior_label_change.txt', 'w') as filehandle:
              filehandle.writelines("%s\n" % place for place in rules_prior_label)
          with open('model_results/norm_2_split/rules_post_map_change.txt', 'w') as filehandle:
              filehandle.writelines("%s\n" % place for place in rules_post_map)
          with open('model_results/norm_2_split/rules_post_all_change.txt', 'w') as filehandle:
              filehandle.writelines("%s\n" % place for place in rules_post_all)
          with open('model_results/norm_2_split/rules_post_all_seed_change.txt', 'w') as filehandle:
              filehandle.writelines("%s\n" % place for place in rules_post_all_seed)




          main_data_formatted.to_csv('model_results/normative_res_two_' + str(rep) + '_change.csv')   # writing main data to new csv file including all relevant data for analysis
