...
#           # print(BICs_baseline_all_subjects_prior)
          ...
          main_data_formatted.to_csv('model_results/normative_res_two_' + str(rep) + '_process_models_sec_rule.csv')   # writing main data to new csv file including all relevant data for analysis
