...
#           print(k)
     ...
     main_data_formatted.to_csv('summary_adaptive_pruned_grammar_1_remains_partial.csv')   # writing main data to new csv file including all relevant data for analysis
