...
# print('cat')
####################### Sampling Algorithm #########################################
def predicted_selections(main_data_formatted, rules_dict, trial_counts, n_rep = 1, n_1=5, n_2=10):  # computes the ll for getting participants responses to initial generalizations (n_1 * n_2 determines number of MCMC iterations)
     ...
     for repeat in np.arange(n_rep):     # for each repeat, an independent outuput file will be created
          ...
          main_data_formatted.to_csv('model_results/normative_res_con_one_' + str(rep) + '_new_modelss1edit.csv')   # writing main data to new csv file including all relevant data for analysis
