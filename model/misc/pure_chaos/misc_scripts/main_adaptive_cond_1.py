...
####################### Custom imports ########################################
from mcmc_adaptive_cond_1 import mh_mcmc_sampler_res
...
main_data_formatted = pd.read_csv('main_data_formatted_cond_1.csv')  # getting the preprocessed data file
...
####################### Sampling Algorithm #########################################
def predicted_selections(main_data_formatted, rules_dict, trial_counts, n_rep = 5, n_1=1, n_2=2):  # computes the ll for getting participants responses to initial generalizations (n_1 * n_2 determines number of MCMC iterations)
     ...
     for repeat in np.arange(n_rep):     # for each repeat, an independent outuput file will be created
          ...
          for data in main_data_formatted['data']:
               ...
               for sample in range(n_1):
                    ...
                    df_post_map = df_post_map.append(mh_mcmc_sampler_res(productions,
                                                             ...
                                                             start_frame=prior_detail[str(map_index)],
                                                             iter = n_2,
                                                             type='posterior_map',
          ...
          # print(BICs_baseline_all_subjects_prior)
          main_data_formatted['fitted_taus_all_subjects_prior'] = fitted_taus_all_subjects_prior * len(main_data_formatted['data'])
          ...
          main_data_formatted['ll_model_all_subjects_prior'] = ll_model_all_subjects_prior* len(main_data_formatted['data'])
          main_data_formatted['BICs_model_all_subjects_prior'] = BICs_model_all_subjects_prior* len(main_data_formatted['data'])
          main_data_formatted['ll_baseline_all_subjects_prior'] = ll_baseline_all_subjects_prior* len(main_data_formatted['data'])
          main_data_formatted['BICs_baseline_all_subjects_prior'] = BICs_baseline_all_subjects_prior* len(main_data_formatted['data'])
          ...
          # print(ll_baseline_all_subjects_prior)
          # print(BICs_baseline_all_subjects_prior)
          main_data_formatted['fitted_taus_all_subjects_post_map'] = fitted_taus_all_subjects_post_map * len(main_data_formatted['data'])
          # main_data_formatted['select_probs_all_subjects_post_map'] = select_probs_all_subjects_post_map
          main_data_formatted['ll_model_all_subjects_post_map'] = ll_model_all_subjects_post_map * len(main_data_formatted['data'])
          main_data_formatted['BICs_model_all_subjects_post_map'] = BICs_model_all_subjects_post_map* len(main_data_formatted['data'])
          main_data_formatted['ll_baseline_all_subjects_post_map'] = ll_baseline_all_subjects_prior * len(main_data_formatted['data'])
          main_data_formatted['BICs_baseline_all_subjects_post_map'] = BICs_baseline_all_subjects_prior* len(main_data_formatted['data'])
          ...
          # print(ll_baseline_all_subjects_prior)
          # print(BICs_baseline_all_subjects_prior)
          main_data_formatted['fitted_taus_all_subjects_post_all'] = fitted_taus_all_subjects_post_all * len(main_data_formatted['data'])
          # main_data_formatted['select_probs_all_subjects_post_all'] = select_probs_all_subjects_post_all
          main_data_formatted['ll_model_all_subjects_post_all'] = ll_model_all_subjects_post_all * len(main_data_formatted['data'])
          main_data_formatted['BICs_model_all_subjects_post_all'] = BICs_model_all_subjects_post_all* len(main_data_formatted['data'])
          main_data_formatted['ll_baseline_all_subjects_post_all'] = ll_baseline_all_subjects_prior* len(main_data_formatted['data'])
          main_data_formatted['BICs_baseline_all_subjects_post_all'] = BICs_baseline_all_subjects_prior * len(main_data_formatted['data'])
          ...
          main_data_formatted.to_csv('model_results/adaptive_res_1_100_cond_1_' + str(rep) + '.csv')   # writing main data to new csv file including all relevant data for analysis
