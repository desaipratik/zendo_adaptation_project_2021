...
####################### Sampling Algorithm #########################################
def predicted_selections(main_data_formatted, n_1=1, n_2=1):  # computes the ll for getting participants responses to initial generalizations (n_1 * n_2 determines number of iterations)
     ...
     main_data_formatted.to_csv('summary_catcat.csv')   # writing main data to new csv file including all relevant data for analysis
