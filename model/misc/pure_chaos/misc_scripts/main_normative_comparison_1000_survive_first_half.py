...
def predicted_selections(main_data_formatted, rules_dict, n_rep=1, n_1=1, n_2=10000):  # computes the ll for getting participants responses to initial generalizations (n_1 * n_2 determines number of iterations)
     ...
     #  looping over each trial for each subject (n_trials * n_subjects iterations and run mcmc chains)
          for data in main_data_formatted['data'][:100]:
               ...
               if len(fitted_taus_prior) % 5 == 0:
                    ...
                    if len(fitted_taus_prior) % 100 == 0:
                         ...
                         baseline_probs_all_subjects = [.5] * 8 * 100
     ...
     ################ APPENDING ALL DATA TO MAIN DATA FRAME ########################
          ...
          main_data_formatted['fitted_taus_all_subjects_prior'] = fitted_taus_all_subjects_prior *  100
          main_data_formatted['select_probs_all_subjects_prior'] = select_probs_all_subjects_prior * 100
          main_data_formatted['ll_model_all_subjects_prior'] = ll_model_all_subjects_prior *  100
          main_data_formatted['BICs_model_all_subjects_prior'] = BICs_model_all_subjects_prior * 100
          main_data_formatted['ll_baseline_all_subjects_prior'] = ll_baseline_all_subjects_prior * 100
          main_data_formatted['BICs_baseline_all_subjects_prior'] = BICs_baseline_all_subjects_prior *  100
          ...
          main_data_formatted['fitted_taus_all_subjects_post_map'] = fitted_taus_all_subjects_post_map *  100
          main_data_formatted['select_probs_all_subjects_post_map'] = select_probs_all_subjects_post_map * 100
          main_data_formatted['ll_model_all_subjects_post_map'] = ll_model_all_subjects_post_map *  100
          main_data_formatted['BICs_model_all_subjects_post_map'] = BICs_model_all_subjects_post_map * 100
          main_data_formatted['ll_baseline_all_subjects_post_map'] = ll_baseline_all_subjects_prior * 100
          main_data_formatted['BICs_baseline_all_subjects_post_map'] = BICs_baseline_all_subjects_prior * 100
          ...
          main_data_formatted['fitted_taus_all_subjects_post_all'] = fitted_taus_all_subjects_post_all * 100
          main_data_formatted['select_probs_all_subjects_post_all'] = select_probs_all_subjects_post_all * 100
          main_data_formatted['ll_model_all_subjects_post_all'] = ll_model_all_subjects_post_all *  100
          main_data_formatted['BICs_model_all_subjects_post_all'] = BICs_model_all_subjects_post_all *  100
          main_data_formatted['ll_baseline_all_subjects_post_all'] = ll_baseline_all_subjects_prior *  100
          main_data_formatted['BICs_baseline_all_subjects_post_all'] = BICs_baseline_all_subjects_prior * 100
          ...
          main_data_formatted.to_csv('full_comparison_1000_survive/8_training_data/full_comparison_5_penalisation' + str(rep) + '_first_half.csv')   # writing main data to new csv file including all relevant data for analysis
