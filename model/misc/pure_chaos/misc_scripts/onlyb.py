...
####################### Sampling Algorithm #########################################
def predicted_selections(main_data_formatted, rules_dict,  replacements, trial_counts, n_rep = 1, n_1=1, n_2=10):  # computes the ll for getting participants responses to initial generalizations (n_1 * n_2 determines number of MCMC iterations)
...
#                          # print(fitted_taus_all_subjects_prior)
                         ...
                         fitted_tau_all_subjects_post_all_seed = minimize(get_tau, 1, bounds=[(0.01, 10000.00)],args=(raw_probs_all_subjects_post_all_seed,resp_all_subjects_post_all_seed), method='L-BFGS-B')
...
#           # print(BICs_baseline_all_subjects_prior)
          ...
          main_data_formatted.to_csv('model_results/normative_res_con_one_' + str(rep) + '_surgerytri.csv')   # writing main data to new csv file including all relevant data for analysis
