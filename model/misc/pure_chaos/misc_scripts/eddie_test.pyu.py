...
####################### Sampling Algorithm #########################################
def predicted_selections(main_data_formatted, n_1=1, n_2=5):  # computes the ll for getting participants responses to initial generalizations (n_1 * n_2 determines number of iterations)
     ...
     print(main_data_formatted)
     print(prior_labels)
     print(post_map_labels)
     print(post_all_labels)
     print(prior_accs)
     print(post_map_accs)
     print(post_all_accs)
     main_data_formatted.to_csv('summary_5_05_50k_full_test_eddie.csv')   # writing main data to new csv file including all relevant data for analysis
