...
####################### Sampling Algorithm #########################################
def predicted_selections(main_data_formatted, n_1=1, n_2=10000):  # computes the ll for getting participants responses to initial generalizations (n_1 * n_2 determines number of iterations)
     ...
     for data in main_data_formatted['data'][:100]:
          ...
          df_prior.to_csv("sampled_rules_5_1/"+token_id + "_" + rule_name + "_prior.csv")       # storing a separate df including rules for each participant
          df_post_map.to_csv("sampled_rules_5_1/"+token_id + "_" + rule_name + "_post_map.csv")
          df_post_all.to_csv("sampled_rules_5_1/"+token_id + "_" + rule_name + "_post_all.csv")
     ...
     main_data_formatted.to_csv('summary_5_1.csv')   # writing main data to new csv file including all relevant data for analysis
