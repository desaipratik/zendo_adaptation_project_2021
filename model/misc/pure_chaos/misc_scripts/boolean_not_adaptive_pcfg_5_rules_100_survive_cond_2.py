...
def predicted_selections(main_data_formatted, rules_dict, trial_counts, n_rep = 5, n_1=1, n_2=1000):  # computes the ll for getting participants responses to initial generalizations (n_1 * n_2 determines number of MCMC iterations)
     ...
     for repeat in np.arange(n_rep):     # for each repeat, an independent outuput file will be created
          ...
          # print(BICs_baseline_all_subjects_prior)
          main_data_formatted['fitted_taus_all_subjects_prior'] = fitted_taus_all_subjects_prior * 210
          ...
          main_data_formatted['ll_model_all_subjects_prior'] = ll_model_all_subjects_prior* 210
          main_data_formatted['BICs_model_all_subjects_prior'] = BICs_model_all_subjects_prior* 210
          main_data_formatted['ll_baseline_all_subjects_prior'] = ll_baseline_all_subjects_prior* 210
          main_data_formatted['BICs_baseline_all_subjects_prior'] = BICs_baseline_all_subjects_prior* 210
          ...
          # print(ll_baseline_all_subjects_prior)
          # print(BICs_baseline_all_subjects_prior)
          main_data_formatted['fitted_taus_all_subjects_post_map'] = fitted_taus_all_subjects_post_map *   210
          # main_data_formatted['select_probs_all_subjects_post_map'] = select_probs_all_subjects_post_map
          main_data_formatted['ll_model_all_subjects_post_map'] = ll_model_all_subjects_post_map * 210
          main_data_formatted['BICs_model_all_subjects_post_map'] = BICs_model_all_subjects_post_map* 210
          main_data_formatted['ll_baseline_all_subjects_post_map'] = ll_baseline_all_subjects_prior * 210
          main_data_formatted['BICs_baseline_all_subjects_post_map'] = BICs_baseline_all_subjects_prior* 210
          #
          # #
          ...
          # print(ll_baseline_all_subjects_prior)
          # print(BICs_baseline_all_subjects_prior)
          main_data_formatted['fitted_taus_all_subjects_post_all'] = fitted_taus_all_subjects_post_all * 210
          # main_data_formatted['select_probs_all_subjects_post_all'] = select_probs_all_subjects_post_all
          main_data_formatted['ll_model_all_subjects_post_all'] = ll_model_all_subjects_post_all * 210
          main_data_formatted['BICs_model_all_subjects_post_all'] = BICs_model_all_subjects_post_all* 210
          main_data_formatted['ll_baseline_all_subjects_post_all'] = ll_baseline_all_subjects_prior* 210
          main_data_formatted['BICs_baseline_all_subjects_post_all'] = BICs_baseline_all_subjects_prior *210
          ...
          main_data_formatted.to_csv('boolean_adatpive_100_survive/8_training_data/boolean_not_adaptive_pcfg_5_rules_5_penalisation_cond_2' + str(rep) + '.csv')   # writing main data to new csv file including all relevant data for analysis
