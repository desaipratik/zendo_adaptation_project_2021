...
#           # print(BICs_baseline_all_subjects_prior)
          ...
          with open('model_results/test5_split/rules_prior_change_best_edits.txt', 'w') as filehandle:
              filehandle.writelines("%s\n" % place for place in rules_prior)
          with open('model_results/test5_split/rules_prior_label_change_best_edits.txt', 'w') as filehandle:
              filehandle.writelines("%s\n" % place for place in rules_prior_label)
          with open('model_results/test5_split/rules_post_map_change_best_edits.txt', 'w') as filehandle:
              filehandle.writelines("%s\n" % place for place in rules_post_map)
          with open('model_results/test5_split/rules_post_all_change_best_edits.txt', 'w') as filehandle:
              filehandle.writelines("%s\n" % place for place in rules_post_all)
          with open('model_results/test5_split/rules_post_all_seed_change_best_edits.txt', 'w') as filehandle:
          ...
          main_data_formatted.to_csv('model_results/normative_res_two_' + str(rep) + '_process_models_change_best_edits.csv')   # writing main data to new csv file including all relevant data for analysis
