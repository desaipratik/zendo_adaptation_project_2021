...
####################### Custom imports ########################################
from mcmc_cond_1_new_test_change_seq_ib_norm import mcmc_sampler, mcmc_sampler_map_surgery, mcmc_sampler_map
...
# #           # print(BICs_baseline_all_subjects_prior)
          ...
          with open('normative_counts'+str(rep)+'_cond_1_100_final_reps_bn_new_scenes_finalcchekkkkk.txt', 'w') as f_tr:
              for item_tr in n_iter_tr:
                  f_tr.write("%s\n" % item_tr)

          with open('final_resample_probs', 'w') as f_ts:
              for item_ts in wsls_checks:
                  f_ts.write("%s\n" % item_ts)
