...
#           # print(len(select_probs_all_subjects_prior * 450)
          ...
          main_data_formatted.to_csv('model_results/normative_res_two_rev_rule_only.csv')   # writing main data to new csv file including all relevant data for analysis
