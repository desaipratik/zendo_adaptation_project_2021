...
#           # print(BICs_baseline_all_subjects_prior)
          ...
          with open('model_results/norm_3/rules_prior.txt', 'w') as filehandle:
          ...
          with open('model_results/norm_3/rules_post_all_seed.txt', 'w') as filehandle:
              filehandle.writelines("%s\n" % place for place in rules_post_all_seed)



          main_data_formatted.to_csv('model_results/normative_res_cond_three_' + str(rep) + '10k_sec_rule_only.csv')   # writing main data to new csv file including all relevant data for analysis
