...
####################### Custom imports ########################################
from mcmc_cond_3_new_test_change_seq_ib_norm import mcmc_sampler, mcmc_sampler_map_surgery, mcmc_sampler_map
...
# #           # print(raw_probs_all_trials_one_list_prior)
          ...
          with open('wsls3_resample_probs.txt', 'w') as f_tr:
              for item_tr in wsls_checks:
                  f_tr.write("%s\n" % item_tr)
...
# #           # print(BICs_baseline_all_subjects_prior)
          ...
          with open('normative_counts'+str(rep)+'_cond_3_100_final_reps.txt', 'w') as f_tr:
