...
main_data_formatted = pd.read_csv('../model_fit_rev_generalizations/normative_res_one_10k_second_rule_only.csv')  # getting the preprocessed data file
...
with open('../rules_generated_by_models/process_cond1/rules_post_all_chain_clean_bn.txt', 'r') as filehandle:
...
with open('../rules_generated_by_models/process_cond1/rules_post_all_seed_chain_clean_qual_lambda3_bn.txt', 'r') as filehandle:
    filecontents = filehandle.readlines()
    for line in filecontents:
        # remove linebreak which is the last character of the string
        current_place = line[:-1]
...
with open('../rules_generated_by_models/process_cond1/rules_post_map_chain_clean_qual_lambda3_bn.txt', 'r') as filehandle:
    filecontents = filehandle.readlines()
    for line in filecontents:
        # remove linebreak which is the last character of the string
        current_place = line[:-1]
...
with open('../rules_generated_by_models/norm_cond1/rules_prior.txt', 'r') as filehandle:
    filecontents = filehandle.readlines()
    for line in filecontents:
        # remove linebreak which is the last character of the string
        current_place = line[:-1]
...
with open('../rules_generated_by_models/norm_cond1/rules_post_all.txt', 'r') as filehandle:
    filecontents = filehandle.readlines()
    for line in filecontents:
        # remove linebreak which is the last character of the string
        current_place = line[:-1]
...
# print('hiheloos')
rule_comps.to_csv('rule_comp_cond_1_lamb_3_bn.csv')
