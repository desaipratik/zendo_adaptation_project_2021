...
#           # print(BICs_baseline_all_subjects_prior)
          ...
          with open('model_results/norm_2/rules_prior.txt', 'w') as filehandle:
          ...
          with open('model_results/norm_2/rules_post_all.txt', 'w') as filehandle:
          ...
          main_data_formatted.to_csv('model_results/normative_res_two_' + str(rep) + '_10k_129.csv')   # writing main data to new csv file including all relevant data for analysis
