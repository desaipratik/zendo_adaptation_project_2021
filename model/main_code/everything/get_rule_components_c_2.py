...
main_data_formatted = pd.read_csv('model_results/normative_res_two_0_process_models_qual_fit_poiss_lambada3.csv')  # getting the preprocessed data file
...
print('hiheloos')
rule_comps.to_csv('model_results/rule_comp_cond_2_lambda_3.csv')
