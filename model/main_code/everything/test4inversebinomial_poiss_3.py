...
# #           # print(BICs_baseline_all_subjects_prior)
          ...
          with open('tr_counts'+str(rep)+'_cond_1_poiss_3_final_reps_bn2_del.txt', 'w') as f_tr:
              for item_tr in n_iter_tr:
                  f_tr.write("%s\n" % item_tr)

          with open('ts_counts'+str(rep)+'_cond_1_poiss_3_final_reps_bn2_del.txt', 'w') as f_ts:
