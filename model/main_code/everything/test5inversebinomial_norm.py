...
#                # print('prior_labesl')
               ...
               n_trials_counter+=1
               continue
               #covert list of dicts into single dict
               # prior_detail_label = {}
...
# #                # print(raw_probs_all_trials_one_list_prior)
          ...
          with open('wsls2_resample_probs.txt', 'w') as f_tr:
...
# #           # print(BICs_baseline_all_subjects_prior)
          ...
          with open('normative_counts'+str(rep)+'_cond_2_100_final_reps.txt', 'w') as f_tr:
